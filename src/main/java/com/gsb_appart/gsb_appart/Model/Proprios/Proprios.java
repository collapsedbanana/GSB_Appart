...
public class Proprios extends Utilisateur {
    ...
    public Proprios(  String adresse, int code_ville,LocalDate date_naiss, String email,String login, String mdp, String nom,String prenom,  int tel, float Cotisation_GSB)  {
